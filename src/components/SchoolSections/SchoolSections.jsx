...
const SchoolSections = () => {
  ...
  return (
    <section className="relative py-24 md:py-32 bg-gradient-to-b from-[#f7faff] to-white overflow-hidden">
      ...
      {/* glow */}
      <div className="absolute top-20 left-0 w-60 h-60 bg-yellow-400/10 blur-3xl rounded-full" />
      <div className="absolute bottom-20 right-0 w-60 h-60 bg-yellow-400/10 blur-3xl rounded-full" />

      <div className="relative max-w-7xl mx-auto px-4">

        {/* Heading */}
        <div className="text-center max-w-3xl mx-auto mb-16 md:mb-24">
          <h2 className="text-3xl md:text-7xl font-semibold text-yellow-400 mb-4">
            Our School Sections
          </h2>
          <p className="text-gray-600 text-base md:text-lg">
            Academic stages designed to nurture confidence, curiosity, and success.
          </p>
          <div className="w-20 h-[3px] bg-gradient-to-r from-yellow-400 to-yellow-400 mx-auto mt-5 rounded-full" />
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 md:gap-20 items-center">
          ...
          <div className="text-center lg:text-left">
            <span className="inline-block mb-3 text-yellow-400 font-semibold tracking-widest uppercase text-xs">
              {active.subtitle}
            </span>

            <h3 className="text-2xl md:text-4xl font-semibold text-yellow-400 mb-5">
            ...
            <ul className="space-y-4 mb-10 max-w-md mx-auto lg:mx-0">
              {active.points.map((point, i) => (
                <li key={i} className="flex items-start gap-4 text-gray-700">
                  <span className="mt-2 w-2.5 h-2.5 rounded-full bg-gradient-to-r from-yellow-500 to-yellow-500" />
                  {point}
                </li>
              ))}
            </ul>
